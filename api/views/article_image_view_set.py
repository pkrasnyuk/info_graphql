...
from api.serializers import ArticleImageSerializer
...
class ArticleImageList(generics.ListCreateAPIView):
    ...
    queryset = ArticleImage.objects.all().cache(ops=['get', 'fetch'],
                                                timeout=1800) if ConnectionValidations.redis_connection_validation() \
